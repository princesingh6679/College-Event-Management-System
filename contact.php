        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1 style="color:#000080 ; font-size:42px ; font-style:bold "><span class="glyphicon glyphicon-user"></span> Sr.EVENT COORDINATOR</h1>
                    <p>
                ...
                <div class="col-md-6 contacts">
                    <h1 style="color:#000080 ; font-size:42px ; font-style:bold "><span class="glyphicon glyphicon-user"></span> Jr. EVENT COORDINATOR  </h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email:collegeevent2@gmail.com<br>
