...
CREATE TABLE `events` (
  ...
  `img_link` varchar(400) DEFAULT NULL,
...
(10, 'MIT-Idol', 100, 0, 'images/idol.jpg', 3),
...
(1, '2024-3-16', '3.00pm', '135 Room'),
(2, '2024-3-16', '1.00pm', '020 Lab'),
(3, '2024-3-17', '11.00am', '136 Room'),
(4, '2024-3-117', '9.30am', '020 Lab'),
(5, '2024-4-10', '10.00am', '121 Lab'),
(6, '2024-4-10', '11.00am', '122 Lab'),
(7, '2024-4-10', '9.30pm', 'ON Stage'),
(8, '2024-4-11', '7.00pm', 'ON Stage'),
(9, '2024-4-11', '5.00pm', 'ON Stage'),
(10, '2024-4-17', '6.00pm', 'ON Stage'),
(11, '2024-4-16', '10.30am', '123 Room'),
(12, '2024-4-16', '10.00am', '021 Lab'),
(13, '2024-5-02', '3pm', '021 lab'),
(14, '2024-5-02', '2.00pm', 'Quandrangle');
...
INSERT INTO `participent` (`usn`,`pass`, `name`, `branch`, `class`, `email`, `phone`, `college`) VALUES
('TI020', 'abc123' ,'Anu', 'BBA', 'SY', 'annapoornaba@gmail.com', '8123300011', 'MITACSC'),
('FI012', 'hello12','BHAVANA', 'CSE', 'TY', 'BHAVANA@GMAIL.COM', '9934736623', 'MITWPU'),
('SI035', 'kavya111','Kavya', 'BCA', 'SY', 'Kavya@gmail.com', '7888387323', 'VIIT');
