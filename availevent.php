        ...
        <div class = "content"><!--body content holder-->
            <div class = "container">
                <div class = "col-md-12"><!--body content title holder with 12 grid columns-->
                    <h1 style="color:#000080 ; font-size:42px ; font-style:bold "><strong>  Participate in your Favourite events:</strong></h1><!--body content title-->
...
<div class = "container  bg-info ">
                <div class = "text-center"><!--body content title holder with 12 grid columns-->
                    <h1 style="color:Purple ; font-size:42px ; font-style:bold "><strong>OUR SPONSERS</strong></h1><!--body content title-->
